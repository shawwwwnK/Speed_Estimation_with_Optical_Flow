...
def main():
    ...
    for epoch in range(finetune_epochs):
        ...
        running_epe = 0.0
        running_f1 = 0.0
        for i, (image1, image2, flow_gt, valid_flow_mask) in enumerate(finetune_loader):
        ...
        print(f'Epoch {epoch + 1} finished in {round(time.time() - start, 1)} secs: EPE {running_epe}')
